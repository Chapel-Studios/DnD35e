...
export async function getCombatantActionEconomy (page: Page, combatId: string, combatantId: string): Promise<{
  ...
  return page.evaluate(({ combatId, combatantId }) => {
    ...
    return {
      actions: { standard: true, move: true, minor: true, aoo: 0, ...stored.actions },
      bab: { main: 0, off: 0, ...stored.bab },
      used: { standard: false, move: false, minor: false, standardAttackUsed: false, movedAfterAttack: false, chargedThisTurn: false, ...stored.used },
    };
