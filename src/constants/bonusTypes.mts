...
const BONUS_TYPE = {
  UNTYPED: BONUS_TYPE_UNTYPED,
  MATERIAL: BONUS_TYPE_MATERIAL,
  BROKEN: BONUS_TYPE_BROKEN,
  ENHANCEMENT: BONUS_TYPE_ENHANCEMENT,
  ARMOR: BONUS_TYPE_ARMOR,
  SHIELD: BONUS_TYPE_SHIELD,
  NATURAL: BONUS_TYPE_NATURAL,
  SIZE: BONUS_TYPE_SIZE,
} as const;
