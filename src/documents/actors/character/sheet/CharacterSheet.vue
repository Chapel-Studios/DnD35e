...
<script lang="ts" setup>
  ...
  import { abilitiesTab, biographyTab, featuresTab, inventoryTab } from '@actors/creature/sheet/tabs/index.mjs';
  ...
  const store = useActorSheetStore<ActorDnd35e>(props.context, {
    defaultTabs: [abilitiesTab, inventoryTab, featuresTab, actorEffectsTab, biographyTab],
