...
function registerGameRulesSettings(): void {
  game.settings.register(SYSTEM_ID, SETTINGS.DIAGONAL_MOVEMENT, {
  ...
  game.settings.register(SYSTEM_ID, SETTINGS.EXPERIENCE_RATE, {
  ...
  game.settings.register(SYSTEM_ID, SETTINGS.DISABLE_EXPERIENCE_TRACKING, {
  ...
  game.settings.register(SYSTEM_ID, SETTINGS.USE_FRACTIONAL_BASE_BONUSES, {
  ...
  game.settings.register(SYSTEM_ID, SETTINGS.ALLOW_BACKGROUND_SKILLS, {
  ...
  game.settings.register(SYSTEM_ID, SETTINGS.PSIONICS_ARE_DIFFERENT, {
  ...
  game.settings.register(SYSTEM_ID, SETTINGS.MEASURE_STYLE, {
