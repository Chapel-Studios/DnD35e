...
| 3-state AE visibility | **Deferred to beta** | [post.1 Community Hardening](../post-release/phase-01-community-hardening.md) | Upgrade from 2-state (hidden/identified) to 3-state (unknown/known-unidentified/identified). Community hardening is the natural fit for UX refinements. |
