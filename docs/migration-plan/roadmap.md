...
`docs/migration-plan/poc/` | poc.1–poc.11
...
| 10 | [Basic Combat](poc/phase-10-basic-combat.md) | � In Progress | poc.6, poc.7, poc.9 | Combat tracker functional; detects basic move, double move, and main-hand attack. Seeds alpha.3 Action System. |
